...
.stat-value { font-size: 2.2em; font-weight: 800; margin-bottom: 6px; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text; }
...
<div style='font-size: 1.4em; font-weight: 700; margin-bottom: 8px;'>🕐 Today's Predictions Coming Soon</div>
<div style='font-size: 1em; opacity: 0.95;'>Our AI is analyzing today's games. Check back at <strong>12:00 PM ET</strong> for predictions!</div>
</div>
