...
def update_latest_predictions():
    ...
    content += ".blog-container { max-width: 100%; margin: 0 auto; background: white; }\n"
    ...
    content += ".content-wrapper { padding: 0 60px 40px 60px; max-width: 1400px; margin: 0 auto; }\n"
    content += ".stats-grid { display: grid; grid-template-columns: repeat(auto-fit, minmax(180px, 1fr)); gap: 20px; margin: -40px 60px 40px 60px; max-width: 1400px; margin-left: auto; margin-right: auto; position: relative; z-index: 10; }\n"
